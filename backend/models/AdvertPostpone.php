 ...
 */
class AdvertPostpone extends Common
{
    public static function tableName()
    {
        return '{{%advert_postpone}}';
    }
    ...
    public function doPostpone() {
        ...
        try {
            ...
            $info = Advert::getOneByWhere(['id' => $id], ['id', 'advert_balance', 'advert_name', 'end_time']);

            $data['update_time'] = date('Y-m-d H:i:s');
            $data['end_time'] = $this->getPostponeEndTime($postponeNum, $timeUnit, $info['end_time']);
