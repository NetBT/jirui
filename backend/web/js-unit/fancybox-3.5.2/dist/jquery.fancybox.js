    ...
    $.extend(FancyThumbs.prototype, {
        ...
        create: function () {
            ...
            if (!self.$grid) {
                ...
                // Add "click" event that performs gallery navigation
                self.$grid.on("click", "button", function (ev) {
                    let oevent = ev||event;
                    oevent.cancelBubble = true;
                    oevent.stopPropagation();
                    let index = $(this).attr("data-pos");
                    instance.group.splice(parseInt(index), 1);
                    if (instance.group.length < 0) {
                        $.fancybox.destroy();
                        return false;
                    }
                    self.create();
            ...
            $.each(instance.group, function (i, item) {
                ...
                list.push(
                    ...
                    '><button class="btn btn-box-tool" style="z-index:99999;position:absolute;top:7px;left:60px;" data-pos="' + i + '" data-widget="remove"><i class="fa fa-times"></i></button></a>'
                );
            });
