<div class="main-page col-xs-12">
    <div class="main-header col-xs-12">
        <div class="header-title col-xs-12"><b>数据备份</b>Export Excel</div>
...
<script>
    $(function(){
        ...
        DataTable.init('initExportExcelList','#exportExcelList','<?= \yii\helpers\Url::to(['security/list','type' => \common\models\Status::MODULE_TYPE_HEADQUARTERS])?>',{});
        //刷新事件
