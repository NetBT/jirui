...
<article class="page-container col-xs-12">
    <?php $form = \yii\bootstrap\ActiveForm::begin([
            ...
            'validationUrl' => \yii\helpers\Url::to(['ab-goods/validate-form', 'type' => 'add']),
        ]
    );
    ?>
    <div class="col-xs-6 col-sm-6 cl text-center">
        ...
        ])->textInput(["value" => \backend\models\AbGoods::makeGoodsCode(), 'class' => 'form-control input-text'])?>
    </div>
    <div class="col-xs-6 col-sm-6 cl text-center">
    ...
    <div class="col-xs-12 col-sm-12 cl text-center">
        <button type="button" onclick="add()" class='btn btn-hot btn-md margin-right-30'>添加并入库</button>
...
<script>
    ...
    function goods_image_add(){
        layer_show({}, '', '<?= \yii\helpers\Url::to(['ab-goods-images/edit'])?>');
    }

    function add() {
        ajaxSubmit('<?= \yii\helpers\Url::to(['ab-goods/do-add'])?>',$('#addABGoods').serialize(), function () {
            layer_close();
