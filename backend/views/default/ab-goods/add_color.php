...
<script>
    function doAddGoodsColor() {
        ...
        $('#abgoods-goods_color').append('<label class="radio-inline"><input name="AbGoods[goods_color]" value="' + colorName + '" type="radio">' + colorName + '</label>');
        layer.closeAll();
        layer.msg(colorName + '添加成功', {icon: 6});
    }
</script>
