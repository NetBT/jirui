...
<article class="page-container">
    ...
    <div class="col-xs-12 col-sm-12 cl text-center margin-top-20 margin-bottom-10">
        <button type="button" onclick="doAdd()" class='btn btn-hot btn-md margin-right-30'>确认</button>
...
<script type="text/javascript">
    ...
    function doAdd() {
        ajaxSubmit('<?= \yii\helpers\Url::to(['ab-suppliers/do-add'])?>', $("#add").serialize(), function () {
