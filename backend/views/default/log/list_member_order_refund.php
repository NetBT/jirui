<div class="main-page col-xs-12">
    <div class="main-header col-xs-12">
        <div class="header-title col-xs-12"><b>会员退单列表</b>List of Member Order</div>
    ...
    <div class="main-body col-xs-12">
        <table class="tab" width="100%" border="0" cellspacing="0" cellpadding="0" id="memberOrderRefundLog"></table>
    </div>
</div>
<script>
    $(function(){

        DataTable.init('initMemberOrderRefundLog','#memberOrderRefundLog','<?= \yii\helpers\Url::to(['log/list-member-order-refund'])?>',getParams());
        ...
        $("#doRefresh").bind('click',function(){
            DataTable.id = '#memberOrderRefundLog';
            DataTable.drawTable();
        });
