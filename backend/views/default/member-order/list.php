<div class="main-page col-xs-12">
    ...
    <div class="main-body col-xs-12">
        <table class="tab" width="100%" border="0" cellspacing="0" cellpadding="0" id="memberOrderList"></table>
    </div>
</div>
...
<script>
    $(function(){
        ...
        DataTable.init('initMemberOrderList','#memberOrderList','<?= \yii\helpers\Url::to(['member-order/list'])?>',getParams());
...
//            layer_show(param, '查看订单', this.editUrl,780,500);
            ...
            creatIframe(this.editUrl+'?id='+id,'订单详情');
//            layer_show_full('订单详情', this.editUrl+'?id='+id);
        ...
        secondModal : function(order_number)
        {
            ...
            layer_show(param, '尾款', this.secondUrl,780,500);
        },
...
//            layer_show_full('添加排项', this.planUrl + "?orderNumber=" + orderNumber);
    ...
    function addRow(obj,orderNum) {
        var table = $('#memberOrderList').DataTable();
        var $obj = $(obj);
