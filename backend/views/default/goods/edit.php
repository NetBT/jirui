...
<article class="page-container col-xs-12">
    <?php $form = \yii\bootstrap\ActiveForm::begin([
            ...
            'validationUrl' => \yii\helpers\Url::to(['goods/validate-form', 'type' => 'edit']),
        ]
    );
    ?>
    <?= $form->field($model,'id',[
    ...
    <div class="col-xs-6 col-sm-6 cl text-center">
        <?= $form->field($model,'goods_color', [
            ...
            'options' => ['class' => '']
        ])->inline()->radioList(\common\models\Status::getGoodsDefaultColor($id), [
    ...
    <div class="col-xs-6 col-sm-6 cl text-center">
        ...
        ])->inline()->radioList(\common\models\Status::getGoodsDefaultSize($id), [
    ...
    <div class="col-xs-12 col-sm-12 cl text-center">
        <button type="button" onclick="edit()" class='btn btn-hot btn-md margin-right-30'>保存</button>
...
<script>
    ...
    function edit() {
        ajaxSubmitForm('#editGoods', '<?= \yii\helpers\Url::to(['goods/do-edit'])?>');
    }
</script>
