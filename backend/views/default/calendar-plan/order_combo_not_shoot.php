<div class="main-page col-xs-12">
    <div class="main-header col-xs-12">
        <div class="header-title col-xs-12"><b>未拍摄列表</b>List of Not Shoot</div>
    ...
    <div class="main-body col-xs-12">
        <table class="tab" width="100%" border="0" cellspacing="0" cellpadding="0" id="notShootList"></table>
    </div>
</div>
<script>
    $(function(){

        DataTable.init('initMemberOrderComboNotShootList','#notShootList','<?= \yii\helpers\Url::to(['calendar-plan/list-order','type' => \common\models\Status::MEMBER_ORDER_COMBO_NOT_SHOOT])?>',getParams());
