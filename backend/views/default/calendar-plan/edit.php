<article class="page-container col-xs-12">
    <?php $form = \yii\bootstrap\ActiveForm::begin(['id' => 'edit',
        ...
        'method' => 'post', 'enableAjaxValidation' => true,
        'validationUrl' => \yii\helpers\Url::to(['calendar-plan/validate-form', 'type' => 'edit']),
    ]);
    ?>
    <?= $form->field($model, 'id', ['template' => '{input}', 'options' => ['class' => 'hidden'], 'labelOptions' => ['class' => 'hidden'],])->hiddenInput() ?>
    <div class="col-xs-12 cl text-center">
        ...
        ])->textInput(['placeholder'=>"订单号", 'value' => $orderNumber, 'class' => 'input-text form-control '])->hint('*必填项')?>
    </div>
    ...
    <div class="col-xs-12 cl text-center">
        ...
        ])->textInput(['placeholder'=>"开始时间", 'id' => 'dateTime', 'class' => 'input-text form-control '])->hint('*必填项')?>
    </div>
    ...
    <div class="col-xs-12 cl text-center">
        ...
        ])->dropDownList(\common\models\Status::getPlanStatusMap(), [
            'class' => 'selectpicker form-control',
            'id' => 'selectStatus',
            'data-title' => '拍摄状态'
        ])?>
    ...
    <div class="col-xs-12 col-sm-12 cl text-center">
        <button type="button" onclick="editCalender()" class='btn btn-hot btn-md margin-right-30'>修改</button>
        <button type="button" onclick="deleteCalender()" class='btn btn-orange btn-md margin-right-30'>删除</button>
